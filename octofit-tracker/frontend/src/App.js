      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
        <div className="container-fluid">
          <Link className="navbar-brand fw-bold d-flex align-items-center" to="/">
            <img src="/octofitapp-small.png" alt="Octofit Logo" className="me-2" style={{ height: '40px', width: '40px', objectFit: 'contain' }} />
            Octofit Tracker
          </Link>
          ...
          <Route path="/" element={
            <div className="d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '60vh' }}>
              <div className="card shadow p-4 mb-4 bg-light rounded" style={{ maxWidth: 500 }}>
                <h1 className="display-5 fw-bold text-primary mb-3">Welcome to Octofit Tracker!</h1>
